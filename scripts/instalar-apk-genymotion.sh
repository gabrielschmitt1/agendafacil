...
echo "📱 Instalador Rápido do AgendaFácil no Genymotion"
echo "================================================="
echo ""

# Diretório do projeto
PROJECT_DIR="/home/gabriel.schimit/Personal/agendafacil"
...
if [ $? -eq 0 ]; then
    ...
    echo "   ======================================"
    echo ""
    echo "📱 Abra o app 'agendafacil' no emulador"
    echo ""
else
    echo ""
    ...
    echo ""
    echo "💡 Tente:"
    echo "   1. Desinstalar versão antiga: adb uninstall com.agendafacil.app"
